...
# file (use in jarfile)
#
SOURCE = $(foreach dir, $(SOURCEDIR), $(wildcard $(dir)/stone/*.java $(dir)/stone/ast/*.java $(dir)/chap6/*.java) $(dir)/chap7/*.java $(dir)/chap8/*.java $(dir)/chap9/*.java $(dir)/chap10/*.java $(dir)/chap11/*.java)
